...
# Function to calculate min and max values of a DataFrame
...
root_directory = '/Users/nityareddy/Desktop/AIML PROJECT/processed'
output_root_directory = '/Users/nityareddy/Desktop/AIML PROJECT/normalized'
...
for dataset_name in ["UMA", "UP", "WEDA"]:   
    ...
    # Process all CSV files in the dataset directory to calculate min and max values
    for root, dirs, files in os.walk(dataset_directory):
        for file in files:
            if file.endswith('.csv'):
                ...
                df_clean = df.dropna(subset=df.columns[1:7]).copy()  # Create a copy of the DataFrame
                ...
                # Save normalized data back to the same CSV file in the output directory
